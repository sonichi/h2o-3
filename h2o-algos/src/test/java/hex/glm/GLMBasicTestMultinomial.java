...
/*    double[][] multinomialBetas = new double[nclass][ncoeffPClass];
  ...
  public void testMultinomialActiveCols() {
    ...
    compareWeightUpdates2Solvers(filename, 100, Solver.IRLSM_SPEEDUP_TEST, Solver.IRLSM_SPEEDUP,
  ...
  public void testMultinomialADMMSpeedUp(){
    ...
    try {
      ...
      GLMModel admmbothreg2 = checkADMM(fr, test, lambdaNative,0.5, true, Solver.IRLSM_SPEEDUP);
      ...
      GLMModel admml2pen2 = checkADMM(fr, test, lambdaNative,0, true, Solver.IRLSM_SPEEDUP);
      ...
      GLMModel admml1pen2 = checkADMM(fr, test, lambdaNative,1, true, Solver.IRLSM_SPEEDUP);
